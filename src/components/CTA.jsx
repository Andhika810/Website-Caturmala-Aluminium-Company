...
Pesan: ${form.message}
  ...
  return (
    <section
      id="kontak"
      className="py-20 px-6 md:px-40 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden w-full"
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* FORM */}
        <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-10 shadow-2xl">
          <form
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg px-4 py-3 bg-white/90 focus:outline-none focus:ring-2 focus:ring-blue-600 text-slate-900"
            ...
            <div className="md:col-span-2 text-center mt-2">
              <button
                type="submit"
                className="w-full md:w-auto inline-flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white px-8 md:px-12 py-4 rounded-xl font-bold text-base md:text-lg transition-all active:scale-95 shadow-xl"
              >
