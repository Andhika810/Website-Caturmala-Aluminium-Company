...
export default function Portfolio() {
  ...
  return (
    <section
      id="portofolio"
      className="py-20 px-6 md:px-40 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 w-full overflow-hidden"
    >
              ...
              >
                <div className="relative overflow-hidden h-60 md:h-72">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="bg-[#473472] text-white px-4 py-1.5 rounded-full text-xs md:text-sm font-semibold">
                      {project.category}
                    </span>
                  </div>
