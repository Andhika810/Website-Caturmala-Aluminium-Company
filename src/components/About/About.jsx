...
export default function About() {
  return (
    <section id="tentang" className="py-20 px-40 bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              ...
              <h2 className="text-4xl md:text-4xl font-bold text-slate-900 mt-3 mb-6">
          ...
          >
            <div>
              <div className="relative mb-12">
                ...
                />
                <div className="absolute -bottom-6 -right-6 w-48 h-48  rounded-2xl -z-10"></div>
              </div>
            </div>
          </motion.div>
        </div>
